...
class User(db.Model, UserMixin):
    ...
    avatar_seed = db.Column(db.String(100), nullable=True, default='GuardianDefault')  # NOVO
...
class QuizAttempt(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    guardian_id = db.Column(db.Integer, db.ForeignKey('guardians.id'), nullable=True, index=True)  # era nullable=False
    ...
    external_user_id = db.Column(db.Integer, db.ForeignKey('usuarios.id'), nullable=True) #user externo
