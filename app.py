...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:%40Slink1205@127.0.0.1/data'
...
app.register_blueprint(admin_v2_bp, url_prefix='/admin-v2') #guardians admin v2
...
def seed_command():
    """Executa todos os seeders para popular o banco de dados."""
    from seed import run_all_seeds
    run_all_seeds()

@app.cli.command("seed-globals")
def seed_globals_command():
    """Popula apenas as configurações globais do jogo."""
    from seed import seed_global_settings
